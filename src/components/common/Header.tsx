...
import { RiArrowDownSLine, RiAuctionLine, RiCloseLine, RiCustomerServiceLine, RiMenuLine, RiPhoneLine, RiSafeLine, RiThunderstormsFill, RiThunderstormsLine, RiToolsLine } from 'react-icons/ri'
// import {
//   ArrowPathIcon,
//   Bars3Icon,
//   ChartPieIcon,
...
const products = [
  { name: 'Analytics', description: 'Get a better understanding of your traffic', href: '#', icon: RiThunderstormsLine },
      ...
      <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
        <div className="flex lg:flex-1">
          <a href="#" className="-m-1.5 p-1.5">
            ...
            <Image src='/images/logo/logo.png' alt="company logo" 
            width={112}
            height={33}
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <a href="/login" className="text-sm font-semibold leading-6 text-gray-900 bg-cyan-400 px-3 py-2 rounded-2xl">
              ...
              <div className="space-y-2 py-6">
                <Disclosure as="div" className="-mx-3">
                  <DisclosureButton className="group flex w-full items-center justify-between rounded-lg py-2 pl-3 pr-3.5 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">
                    Product
                    <RiArrowDownSLine aria-hidden="true" className="h-5 w-5 flex-none group-data-[open]:rotate-180" />
                  </DisclosureButton>
